    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        <div className="project">
          <h2>
            <a
              href="https://react-ecommerce-aahn.vercel.app/"
              target="_blank"
          ...
          <p>
            Developed a fully responsive e-commerce web application using React.js,
            Redux, Bootstrap, and Fake Store API. Implemented product browsing,
            category filtering, shopping cart functionality, and dynamic state
            management with Redux. Deployed the application on Vercel and optimized
