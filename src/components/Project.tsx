...
function Project() {
    ...
    {/* <ul>
        ...
        <li>Fully responsive on all screen sizes</li>
            ...
            <div className="project">
                <a href="" target="_blank" rel="noreferrer"><h2>Task Management Web App</h2></a>
            ...
            <div className="project">
                <a href="" target="_blank" rel="noreferrer"><h2>Real-time Chat Application</h2></a>
            ...
            <div className="project">
                <a href="" target="_blank" rel="noreferrer"><h2>Resume Builder</h2></a>
            ...
            <div className="project">
                <a href="" target="_blank" rel="noreferrer"><h2>Fraud Prevention in Real Estate using Blockchain</h2></a>
